...
from .views import add_weblink, my_weblinks, all_links_view, edit_weblink, delete_weblink, share_weblink, shared_links_view, share_all_weblinks, update_permission
